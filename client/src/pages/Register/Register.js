...
const Register = () => {
  ...
  const submitUserData = async(e) => {
    ...
    const { fname, lname, email, mobile, gender, description } = inputdata;
            ...
            <Form>
              <Row>
                ...
                <Form.Group className="mb-3 col-lg-6" controlId="formBasicEmail">
                  ...
                  <Form.Control type="text" name='description' value={inputdata.description} onChange={setInputValue} placeholder='Enter Your description' />
                </Form.Group>
